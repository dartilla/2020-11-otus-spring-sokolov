package ru.dartilla.bookkeeper.mms.mongock.changelog;

import com.github.cloudyrock.mongock.ChangeLog;
import com.github.cloudyrock.mongock.ChangeSet;
import com.github.cloudyrock.mongock.driver.mongodb.springdata.v3.decorator.impl.MongockTemplate;
import com.mongodb.client.MongoDatabase;
import ru.dartilla.bookkeeper.mms.mongo.domain.*;
...
public class DatabaseChangelog {
    ...
    private Map<String, Comment> commentIndex = List.of(
            ...
            new Comment("1003", scriptIndex.get("1004"), null, "Уснул на заглавии")
