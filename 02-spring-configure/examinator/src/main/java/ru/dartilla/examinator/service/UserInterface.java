...
public class UserInterface {
    ...
    public void printQuestion(Excercise excercise) {
        StringBuilder sb = new StringBuilder("\t");
        for (String answer : excercise.getAnswersToChoose()) {
            if (sb.length() > 1) {
                sb.append(", ");
            }
            sb.append(answer);
        ...
        sb.insert(0, System.lineSeparator() + excercise.getQuestion() + System.lineSeparator());
